...
console.log('Humberto Melean'.split(' '));

const [firstName, lastName] = 'Humberto Melean'.split(' ');
...
capitalizeName('humberto melean');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(25, '+').padEnd(35, '-'));
console.log('Beto'.padStart(25, '+'));
...
console.log(airline.indexOf('portual'));
...
console.log(new Set('HumbertoMelean'));
...
// Example
const days = ['mon', 'teu', 'wed', 'thur', 'fri', 'sat', 'sun'];
...
const users = [{ email: 'Hello@gmail.com' }];
...
restaurant.orderPizza && restaurant.orderPizza(11, 22, 33);
...
restaurant.orderPizza(1, 2, 3, 4, 5);
